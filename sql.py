...
class SQLDB:
    ...
    def __get_table_schema(self, table):
        ...
        if not result: raise Exception('Wrong table name')
        return result
    ...
    def insert_or_update(self, table, data, check_field):
        self.__create_table_if_not_exists(table)
...
db.insert_or_update('Low', dict(nome='Luca'), 'nome')   